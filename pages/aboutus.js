...
const aboutus = () => {
    return(
        <Layout>
            <h1 className="w-full flex justify-center" style={{fontSize:30, color: "white", backgroundColor: "#2F4993"}}>Thank you For Choosing Transcontinental Connections</h1><br/>
